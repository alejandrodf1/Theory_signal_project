# teoria project guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `teoria_project/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `teoria_project` folder and use the modules inside your notebooks :
...
```python
from teoria_project.utils.paths import data_dir
data_dir()
```
